...
### Phase 54: 系统菜单分组与层级整理
- [x] 将参数/字典从系统管理拆分到参数管理
- [x] 将代码生成拆分到开发工具并同步旧库迁移逻辑
- [x] 完成前后端菜单结构与初始化 SQL 回归
- **Status:** complete

### Phase 55: 系统通知最小闭环
- [ ] 设计并落地通知主表 / 目标表 / 用户收件箱表
- [ ] 实现通知管理接口（创建、更新、立即发布、定时发布、取消、详情、列表）
- [ ] 实现我的消息接口（列表、详情、未读数、最近消息、标记已读、全部已读）
- [ ] 接入定时发布扫描任务并补齐关键测试
- [ ] 完成前后端最小联调与规划文件同步
- **Status:** in_progress
